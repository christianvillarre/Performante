...
\n\n/* ============================================================================\n   BLACK5 — FOOTER MOTION\n   ============================================================================ */\n(() => {\n  if (typeof gsap === "undefined") return;\n  const footer = document.querySelector(".pw5-footer");\n  if (!footer || window.matchMedia("(prefers-reduced-motion: reduce)").matches) return;\n\n  const brand = footer.querySelector(".pw5-footer__brand");\n  const columns = gsap.utils.toArray(footer.querySelectorAll(".pw5-footer__column"));\n  const wordmark = footer.querySelector(".pw5-footer__wordmark");\n  const bottom = footer.querySelector(".pw5-footer__bottom");\n\n  gsap.set([brand, ...columns, bottom], { autoAlpha:0, y:26 });\n  gsap.set(wordmark, { autoAlpha:0, y:44, filter:"blur(8px)" });\n\n  let revealed = false;\n  function revealFooter(){\n    if (revealed) return;\n    const rect = footer.getBoundingClientRect();\n    if (rect.top <= window.innerHeight * 1.02){\n      revealed = true;\n      gsap.ticker.remove(revealFooter);\n      const tl = gsap.timeline({ defaults:{ ease:"power3.out" } });\n      tl.to(brand,{autoAlpha:1,y:0,duration:.75})\n        .to(columns,{autoAlpha:1,y:0,duration:.7,stagger:.07},"-=.5")\n        .to(wordmark,{autoAlpha:1,y:0,filter:"blur(0px)",duration:1.05},"-=.35")\n        .to(bottom,{autoAlpha:1,y:0,duration:.6},"-=.55");\n    }\n  }\n\n  gsap.ticker.add(revealFooter);\n  revealFooter();\n})();\n/* ============================================================================\n   END BLACK5 — FOOTER MOTION\n   ============================================================================ */\n